      ...
      <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8">
        <form className="">
            <div className="mb-3">  
              ...
              <p className="text-center text-[14px] text-gray-500 mb-2">We&apos;ve send a code to your mail box</p>
              { alert.isShow && (
                <BaseAlert alert={{ type: alert.type, message: alert.message }} />
              )}
            </div>
            <div className="mb-6">
                <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900">OTP</label>
                <input
                  type="text"
                  name="name"
                  id="name"
